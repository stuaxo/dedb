"""The backend contract (:class:`BackendBase`) and game-reference
resolution (:func:`resolve` / :func:`resolve_game`).
...
``dedb.core.get_backends()`` (dedb.core.registry) imports those modules and
...
class BackendBase:
    ...
    def layout(self, identifier: str):
        ...
        return self.layout_cls(downloads.require_download_dir(self.scheme), identifier)
    ...
    def local_names(self) -> "list[str]":
        ...
        target resolution."""
        root = settings.get_settings().download_dir_for(self.scheme)
    ...
    def refresh_metadata(self, identifiers: "list[str]") -> None:
        ...
        for identifier in identifiers:
            ...
            downloader.rewrite_metadata(layout)
